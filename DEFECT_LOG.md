...
| D5 | TC088 | Cancellation immediately changed a confirmed booking to cancelled without displaying the required refund preview. | Medium | Fixed in source; live cancellation retest pending | Cancellation now requires a preview step showing notice-window information, refund percentage, and refund amount before confirmation. |
